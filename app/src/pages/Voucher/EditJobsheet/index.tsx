...
class EditJobsheet extends Component<any, any> {
    ...
    copyItemsForVoucher = (voucherid: any, label: any) => {
        const {navigation, vouchers, voucheritems, updateVoucherItems, setVoucherItems, setAlert} = this.props;
                        ...
                        <KeyboardScroll>
                            ...
                            <View
                                ...
                                <View style={[styles.grid, styles.justifyContent,]}>
                                    ...
                                    {voucher.data.voucherid && isDone && <View>
                                        {!Boolean(voucher.data.convertedid) ? <TouchableOpacity onPress={() => {
                                            ...
                                            onPress={() => {
                                                ...
                                                voucher.type = getVoucherTypeData("vouchertypeid", "b152d626-b614-4736-8572-2ebd95e24173", values.converteddisplayid, values.convertedto);
                                            ...
                                            }]}>{`Converted to ${voucher.data.convertedid}`}</Paragraph>
                                        </TouchableOpacity>}
                                    </View>}
